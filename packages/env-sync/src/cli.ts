...
import type { CliOptions, SyncResult } from './types.js';
...
function parseCliOptions(): CliOptions {
    ...
    return {
        provider:      (getFlag('--provider') ?? null) as CliOptions['provider'],
...
async function loadLocalCredentials(root: string): Promise<void> {
